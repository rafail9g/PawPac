...
Route::middleware([RoleMiddleware::class . ':adopter'])->group(function () {
    ...
    Route::get('/adopter/profile', function () {
        return view('adopterprofile', ['user' => auth()->user()]);
    })->name('adopter.profile');

    Route::put('/adopter/profile', [AdopterController::class, 'updateProfile'])->name('adopter.profile.update');
});
